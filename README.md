...
CodeFolio is a multi-user web platform that allows developers to create a professional portfolio at a personal URL (`codefolio.app/username`) without the overhead of setting up or maintaining their own infrastructure.
...
- **Public Portfolio Page** — Accessible at `codefolio.app/username`, no login required
